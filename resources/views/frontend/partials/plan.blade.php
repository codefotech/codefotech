...
<section id="plan" class="plan container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="section-title-2 text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            <h5 class="fw-bold codefotech_text_color text-uppercase">Pricing Plans</h5>
            ...
            <div class="col-lg-12">
                <div class="table-responsive wow fadeInUp" data-wow-delay="0.3s">
                    <table class="price-table table align-middle table-hover mb-0">
                        ...
                        <tr>
                            <td>1. HTML5 & CSS3</td>
                            <td><i class="fa fa-check codefotech_text_color"></i></td>
                            <td><i class="fa fa-check codefotech_text_color"></i></td>
                            <td><i class="fa fa-check codefotech_text_color"></i></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th></th>
                            <th><a href class="btn codefotech_color py-2 px-4">Sign Up</a></th>
                            <th><a href class="btn codefotech_color py-2 px-4">Order Now</a></th>
                            <th><a href class="btn codefotech_color py-2 px-4">Order Now</a></th>
                        </tr>
                        </tfoot>
                    </table>
