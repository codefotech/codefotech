        ...
        <div class="row g-5">
            <div class="col-lg-7">
                <div class="section-title-2 position-relative pb-3 mb-5">
                    <h5 class="fw-bold codefotech_text_color text-uppercase">Request A Quote</h5>
                    <h1 class="mb-0">Need A Free Quote? Please Feel Free to Contact Us</h1>
                </div>
                <div class="row gx-3">
                    <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                        <h5 class="mb-4"><i class="fa fa-reply codefotech_text_color me-3"></i>Reply within 24 hours</h5>
                    </div>
                    <div class="col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                        <h5 class="mb-4"><i class="fa fa-phone-alt codefotech_text_color me-3"></i>24 hrs telephone support
                        </h5>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center mt-2 wow zoomIn" data-wow-delay="0.6s">
                    ...
                    <div class="ps-4">
                        ...
                        <h4 class="codefotech_text_color mb-0">+880 1896086540</h4>
                    </div>
                </div>
            </div>
            <div class="col-lg-5">
                <div class="codefotech_color rounded h-100 d-flex align-items-center p-5 wow zoomIn"
                     data-wow-delay="0.9s">
                    <form>
                        <div class="row g-3">
                            <div class="col-xl-12">
