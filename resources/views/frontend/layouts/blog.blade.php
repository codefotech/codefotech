...
<head>
    ...
    <title>Blog - Codefotech Website</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="assets-2/img/favicon.ico" rel="icon">
    <link href="assets-2/img/CodeFoTech-1.png" rel="Codefotech">
...
<body>
    ...
    <header id="header" class="header fixed-top">
        ...
        <span>FlexStart</span> -->
                <img src="assets-2/img/CodeFoTech-1.png" alt="Codefotech">
            </a>
    ...
    <footer id="footer" class="footer">
              ...
              <span>FlexStart</span> -->
                    ...
                    <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
                        ...
                        <p>
                            ...
                            Sector -12, <br>
                            Uttara, Dhaka<br><br>
                            <strong>Phone:</strong> +880 1896086540<br>
                            <strong>Email:</strong> codefotech@gmail.com<br>
                        </p>
        ...
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>Codefotech</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
