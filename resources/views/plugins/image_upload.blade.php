...
<script src="{{ asset("assets/croppie-2.6.2/croppie.min.js") }}"></script>
<script src="{{ asset("assets/facedetection.js") }}" type="text/javascript"></script>
<link rel="stylesheet" href="{{ asset("assets/croppie-2.6.2/croppie.min.css") }}">
