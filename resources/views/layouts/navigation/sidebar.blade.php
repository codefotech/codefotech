<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        ...
        <a href="" class="navbar-brand">
            <h2 class="m-0 codefotech_text_color"><i class="fa fa-book me-3"></i>LMS</h2>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        @can('user')
            <li
                class="menu-item {{ Request::is('users') || Request::is('users/*') ? 'active' : '' }} {{ Request::segment(1) == 'users' ? 'open' : '' }}">
